<?php /* Smarty version 2.6.18, created on 2018-09-17 11:36:36
         compiled from advertiser-index-list.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 't', 'advertiser-index-list.html', 18, false),array('function', 'rv_add_session_token', 'advertiser-index-list.html', 37, false),array('function', 'ox_column_class', 'advertiser-index-list.html', 90, false),array('function', 'ox_column_title', 'advertiser-index-list.html', 91, false),array('function', 'cycle', 'advertiser-index-list.html', 135, false),array('function', 'ox_entity_id', 'advertiser-index-list.html', 149, false),array('function', 'ox_column_updated', 'advertiser-index-list.html', 153, false),array('modifier', 'count', 'advertiser-index-list.html', 102, false),array('modifier', 'escape', 'advertiser-index-list.html', 146, false),)), $this); ?>
...
'>
                    <?php echo OA_Admin_Template::_function_ox_column_title(array('item' => 'updated','order' => 'up','default' => 0,'str' => 'Updated','url' => "advertiser-index.php"), $this);?>
...
' class='inlineIcon iconAdvertiser'><?php echo ((is_array($_tmp=$this->_tpl_vars['client']['clientname'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
                ...
                <td>
                    <?php echo OA_Admin_Template::_function_ox_column_updated(array('updated' => $this->_tpl_vars['client']['updated']), $this);?>
