<?php /* Smarty version 2.6.18, created on 2018-09-17 11:37:17
...
;
    var CAMPAIGN_TYPE_OVERRIDE = <?php echo $this->_tpl_vars['CAMPAIGN_TYPE_OVERRIDE']; ?>
;
...
;
    ...
    <?php if ($this->_tpl_vars['MODEL_MT'] != ''): ?>
        MODEL_MT = <?php echo $this->_tpl_vars['MODEL_MT']; ?>
;
    <?php endif; ?>
...
;
    ...
    var strCampaignWarningNoTargetMessage = '<?php echo OA_Admin_Template::_function_t(array('str' => 'CampaignWarningNoTarget','escape' => 'javascript'), $this);?>
';
    var strCampaignWarningRemnantNoWeight = '<?php echo OA_Admin_Template::_function_t(array('str' => 'CampaignWarningRemnantNoWeight','escape' => 'javascript'), $this);?>
';
    var strCampaignWarningEcpmNoRevenue = '<?php echo OA_Admin_Template::_function_t(array('str' => 'CampaignWarningEcpmNoRevenue','escape' => 'javascript'), $this);?>
';
    var strCampaignWarningOverrideNoWeight = '<?php echo OA_Admin_Template::_function_t(array('str' => 'CampaignWarningOverrideNoWeight','escape' => 'javascript'), $this);?>
';
